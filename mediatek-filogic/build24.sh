...
PACKAGES="$PACKAGES luci-i18n-nikki-zh-cn luci-i18n-passwall2-zh-cn luci-app-ssr-plus luci-app-lucky luci-i18n-autoreboot-zh-cn"
# USB网卡相关（8156）
PACKAGES="$PACKAGES usbutils kmod-usb-net-rtl8152-vendor"
